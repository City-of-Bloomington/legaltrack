...
public class Address implements java.io.Serializable{
    ...
    String id="", caseId="",
	street_num="",street_dir="", rental_addr="",
	...
	try{
	    ...
	    /*
	      ...
	      stmt.setString(jj++, street_address);
	    */
	}
	catch(Exception ex){
	    logger.error(ex);
	...
	String back = "";
	String qq = "delete from legal_addresses where id=?";
	Connection con = null;
	PreparedStatement stmt = null;
	ResultSet rs = null;		
	if(debug){
    ...
    public boolean isValid(String url2){
	...
	try{
		...
		String street_address_id = jObj.getString("street_address_id");
		if(jObj.has("streetAddress")){
		    street_address = jObj.getString("streetAddress");
		}
    ...
    public boolean isValid3(String url){
	//
	boolean ret = false;
	try{
	    DefaultHttpClient httpclient = new DefaultHttpClient();
